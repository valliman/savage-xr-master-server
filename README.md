...
### Getting Started
Simply download the [savage-master-server-1.3.1.jar](https://github.com/valliman/savage-xr-master-server/releases/download/1.3.1/savage-master-server-1.3.1.jar)

> Open a command shell and start the server with the following command:
* `java -jar savage-master-server-1.3.1.jar`
