...
### Getting Started
Simply download the [savage-master-server-1.2.0.jar](https://github.com/valliman/savage-xr-master-server/releases/download/1.2.0/savage-master-server-1.2.0.jar)

> Open a command shell and start the server with the following command:
* `java -jar savage-master-server-1.2.0.jar`
